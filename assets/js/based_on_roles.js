var data = [
	...
	
	{
		...
		"link": "https://skillscapital.io/"
	},
	{
		"make": "SAP ERP",
		"model": "ERP",
		"type": "SAP Functional FullStack",
		// "price": "$1,500",
		"image": "https://cdn.iconscout.com/icon/free/png-512/free-sap-3521690-2945134.png?f=webp&w=256",
		"link": "https://skillscapital.io/"
	},
...
for (var i = 0; i < data.length; i++) {
    ...
    products2 += "<div class='col-sm-4 product' data-make='" + make + "' data-model='" + model + "' data-type='" + type + "'>"
	+ "<a target=`_blank`	href='"  + link + "'>" // Add this line to start the anchor tag with the demoLink variable
	+ "<div class='product-inner text-center'><img src='" + image + "'>" +  type + "</div>"
	+ "</a>" // Add this line to close the anchor tag
	+ "</div>";
